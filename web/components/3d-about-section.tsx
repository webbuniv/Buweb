...
export function ThreeDAboutSection() {
  ...
  return (
    <section className="section-padding bg-gradient-to-br from-white via-slate-50 to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-blue-900 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-full h-full bg-[url('data:image/svg+xml,%3Csvg width=\"60\" height=\"60\" viewBox=\"0 0 60 60\" xmlns=\"http://www.w3.org/2000/svg\"%3E%3Cg fill=\"none\" fillRule=\"evenodd\"%3E%3Cg fill=\"%239C92AC\" fillOpacity=\"0.05\"%3E%3Ccircle cx=\"30\" cy=\"30\" r=\"1\"/%3E%3C/g%3E%3C/g%3E%3C/svg%3E')] opacity-40" />
        <motion.div 
        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="space-y-6">
              ...
              >
                Committed to{" "}
                <span className="gradient-text bg-gradient-to-r from-green-600 via-blue-600 to-purple-600 bg-clip-text text-transparent">
              ...
              >
                <p className="text-body leading-relaxed">
                  For over seven decades, Bugema University has been a beacon of quality Christian education in Uganda and East
                  Africa. We are committed to providing holistic education that prepares students for productive
                ...
                <p className="text-body leading-relaxed">
                  ...
                  students gain global perspectives while maintaining strong ethical foundations rooted in Christian values.
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              <motion.div 
                className="relative p-6 glass-card border-l-4 border-gradient-to-b from-blue-500 to-green-500"
            ...
            >
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-700 hover:to-green-700 text-white group transform-gpu hover:scale-105 transition-all duration-300 shadow-xl"
              >
                Learn More About Us
              ...
              {values.map((value, index) => (
                ...
                >
                  <Card className="h-full bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border-0 shadow-lg hover:shadow-2xl transition-all duration-500 group overflow-hidden relative">
                    {/* Gradient Background */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${value.color} opacity-5 group-hover:opacity-15 transition-opacity duration-300`} />
                    ...
                    <CardContent className="p-6 relative z-10">
                      ...
                      <h4 className="font-bold text-foreground mb-3 text-lg group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-300" style={{ backgroundImage: `linear-gradient(to right, ${value.color.split(' ')[1]}, ${value.color.split(' ')[3]})` }}>
                        {value.title}
                      </h4>
