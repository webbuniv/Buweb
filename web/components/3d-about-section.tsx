        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          >
            <div className="space-y-6">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">Why Choose Bugema University?</h3>
            ...
            >
              <Card className="h-full bg-white/70 dark:bg-gray-800/70 backdrop-blur-sm border-gray-200/50 dark:border-gray-700/50 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                <CardContent className="p-8 text-center relative overflow-hidden">
                  ...
                  {/* Icon */}
                  <motion.div
                    className={`w-16 h-16 mx-auto mb-6 bg-gradient-to-br ${feature.color} rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  ...
                  {/* Stats */}
                  <div
                    className={`inline-block px-4 py-2 bg-gradient-to-r ${feature.color} text-white rounded-full text-sm font-semibold`}
                  >
                    {feature.stats}
                  </div>
