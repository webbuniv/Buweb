              ...
              <tr key={key}>
                <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    <div className="h-12.5 w-15 rounded-md">
                      <Image
                        src={`${process.env.NEXT_PUBLIC_APPWRITE_ENDPOINT}/storage/buckets/${process.env.NEXT_PUBLIC_APPWRITE_BUCKET_ID}/files/${teamItem.file}/view?project=${process.env.NEXT_PUBLIC_APPWRITE_PROJECT}`}
                        width={60}
                        height={50}
                        alt="Product"
                      />
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button className="hover:text-primary"
                      onClick={() => handleUpdateEvent(teamItem.$id)}
                    >
                      <svg
                        className="fill-current"
                        width="18"
