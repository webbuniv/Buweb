...
import { getEvents, getEventsById, deleteEvents, updateEvents } from "@/lib/actions/events.actions";
...
const TablesPage = () => {
  ...
  const [ update, setUpdate ] = useState<Events | null>(null);
    ...
    <>
      ...
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          ...
          <tbody>
            {event.map((eventItem, key) => (
              <tr key={key}>
                <td className="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                  <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                    <div className="h-12.5 w-15 rounded-md">
                      <Image
                        src={`${process.env.NEXT_PUBLIC_APPWRITE_ENDPOINT}/storage/buckets/${process.env.NEXT_PUBLIC_APPWRITE_BUCKET_ID}/files/${eventItem.file}/view?project=${process.env.NEXT_PUBLIC_APPWRITE_PROJECT}`}
                        width={60}
                        height={50}
                        alt="Product"
                      />
