...
import ChoirPrograms from '@/components/Religious/ChoirPrograms';
...
const ChoirPage = () => {
  return (
      ...
      <>
      <div 
        className="max-container mt-[100px] lg:h-[600px] h-[300px] -my-4 bg-cover bg-center bg-no-repeat"
        style={{ backgroundImage: 'url(/images/church/choo.jpeg)' }}
      >
