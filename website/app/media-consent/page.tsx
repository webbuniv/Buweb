...
export default function MediaConsentForm() {
    ...
    return (
      <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
        ...
        <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover z-0">
          <source
            src="https://res.cloudinary.com/dirfcqs1f/video/upload/v1749039674/0604_zxkhik.mov"
            type="video/mp4"
          />
        </video>
        ...
        <Link
          href="/"
          className="fixed top-6 left-6 z-30 flex items-center text-white hover:text-blue-200 transition-colors bg-black/50 backdrop-blur-sm px-4 py-3 rounded-lg shadow-lg hover:shadow-xl border border-white/20"
        >
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Video Background */}
      <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover z-0">
        <source src="https://res.cloudinary.com/dirfcqs1f/video/upload/v1749039674/0604_zxkhik.mov" type="video/mp4" />
      </video>
      ...
      <div className="relative z-20 py-20 px-4">
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            <div className="mb-6">
              <div className="w-30 h-30 bg-gradient-to-r from-blue-600 to-green-600 rounded-full flex items-center justify-center mx-auto mb-4">
                {/* <FileText className="w-8 h-8 text-white" /> */}
                <Image
                  src="https://res.cloudinary.com/dirfcqs1f/image/upload/v1749039656/BU_MEDIA_LOGO_gyefyx.png"
                  alt="logo"
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3 p-6 bg-gradient-to-r from-gray-50 to-blue-50 rounded-lg border-2 border-gray-100">
                  ...
                  <label htmlFor="agreeToTerms" className="text-sm text-gray-700 leading-relaxed">
                    ...
                    allow Bugema University to use my image/video for promotional purposes across various media
                    platforms including but not limited to websites, social media, brochures, and marketing materials.{" "}
