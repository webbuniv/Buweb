...
export default function PublicationFeed() {
  ...
  return (
    <div className="pt-20">
        <h1 className="text-3xl font-bold text-center my-2">Bugema University Publications</h1>
        <p className="text-muted-foreground mb-4 text-center">Explore our latest research and academic publications</p>
