...
const Header = () => {
  ...
  return (
    ...
    <>
      ...
      <header
        className={`header top-0 left-0 z-40 flex w-full items-center bg-trasparent ${
          sticky
                ...
                >
                  <ul className="block lg:flex lg:space-x-12">
                        <li className="group relative">
                              <Link
                                    href=""
                                     className={`flex py-2 text-base text-dark group-hover:opacity-70 dark:text-white lg:mr-0 lg:inline-flex lg:py-6 lg:px-0`}  onClick={() => 
                                          setShowModel(true)
                                    } >
                                    Programs
                              </Link>
