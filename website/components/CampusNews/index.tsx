...
const CampusNews = () => {
  ...
  return (
    <section className="py-4 mb-4 px-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-r-full border-r-4 border-yellow-200 dark:from-gray-900 dark:to-gray-800">
