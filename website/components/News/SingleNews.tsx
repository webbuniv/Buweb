...
const SingleEvent = ({ post }: Props) => {
  return (
    <div className="wow fadeInUp relative overflow-hidden rounded-md bg-white shadow-one h-[500px] dark:bg-dark w-[220]">
        ...
        <div className="flex items-center">
          <div className="mr-5 flex items-center border-r border-body-color border-opacity-10 pr-5 dark:border-white dark:border-opacity-10 xl:mr-3 xl:pr-3 2xl:mr-5 2xl:pr-5">
            ...
            <div className="w-full">
              ...
              <p className="text-xs text-body-color">{post.author}</p>
            </div>
          </div>
          <div className="inline-block">
            ...
            <p className="text-xs text-body-color">{new Date(post.date).toDateString()}</p>
          </div>
        </div>
      </div>
    </div>
