      ...
      >
        ...
        <div className="bg-primary/10 py-8">
          <div className="container md:flex md:justify-center text-center md:space-x-12">
            <Link href="/" className="text-center text-base bg-blue-600 text-body-color dark:text-white">
              &#169;  Bugema University
            </Link>
            <h1 className="text-center text-base bg-blue-600 text-body-color dark:text-white">
              <a href="tel:+256-312-351-400">Phone: +256-312-351-400</a>
            </h1>
            <Link href='https://www.bugemauniv.ac.ug' className="text-center text-base bg-blue-600 text-body-color dark:text-white">
