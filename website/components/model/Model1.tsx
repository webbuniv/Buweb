...
const UniversityNavigationModal = ({ issvisible, onClose, children }: NavigationModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-40 bg-gradient-to-br from-red-100 via-green-100 to-purple-100 bg-opacity-50   backdrop-blur-sm animate-in fade-in duration-300" onClick={onClose}>
