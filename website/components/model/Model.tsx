                  ...
                  <div id="programs">
                        ...
                        <div className="vertical-line ml-24 my-24 fade-in "  style={{marginLeft:'115px',marginTop:'25%'}}> 
                              ...
                              <div className="mr-2 my-5  slider slide--slow ">
                                    ...
                                    <h1  style={{color:'gray',fontSize: '25px',cursor:"pointer", marginRight:'5px'}} className='animated font-bold ' onClick={onClose}><span id='payments' className='animated'>Administrators</span></h1>
                                    </Link>
                  ...
                  <div className=" fade-in ml-24 my-24 hidden " style={{marginTop:'6%'}} id='get-in-touch'> 
                        <ul className='ml-10 my-20'>
                              ...
                              <li>
                                    <Link href={"/schools/school-of-graduate"}>
                                    <div className="mr-2 my-5  ">
                                    <h1  style={{fontSize: '15px',cursor:"pointer", marginRight:'5px'}} className='schools text-black font-bold' onClick={onClose}> School of Graduate studies, Research <br/>&  Publications</h1> 
