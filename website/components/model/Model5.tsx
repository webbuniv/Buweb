...
const Model5 = ({is5visible, onClose, children}) => {
      if (!is5visible) return null;
const handleclose = (e)=>{
      ...
      <>
            ...
            <div className=" fade-in fixed inset-0 backdrop-blur-sm flex w-full h-4/5 my-24 overflow-auto overflow-x-hidden bg-white" id="wrapper">
                  ...
                  <div className=" ml-12 my-24 fade-in " id='courses' style={{marginTop:'19%'}}> 
                         ...
                         <h1  style={{marginRight:'2px'}} className='text-black text-center' > Be trained by the qualified! <br/> Explorer our qualified lecturers across different schools... </h1> 
