...
const why_bugema = () =>{
  ...
  return (
      <>
            ...
            <div className=" fade-in fixed z-40 inset-0 backdrop-blur-sm flex w-full h-4/5 my-24 overflow-auto overflow-x-hidden " id="wrapper" onScroll={onClose} onMouseLeave={onClose}>
