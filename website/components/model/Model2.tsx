...
const why_bugema = () =>{
  ...
  return (
      <>
            ...
            <div className=" fade-in fixed z-40 inset-0 backdrop-blur-lg flex ml-[5%]  w-[90%] h-[60%] mt-[10%] border rounded-3xl border-black overflow-auto overflow-x-hidden bg-gradient-to-b from-white  to-transparent" id="wrapper" onMouseLeave={onClose}  >
