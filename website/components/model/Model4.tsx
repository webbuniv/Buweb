  ...
  return (
    ...
    >
      <div id="programs">
        ...
        <div className="vertical-line ml-12 my-24 fade-in">
          <div className="mr-2 my-5 slider slide--fast">
            <h1
              style={{ color: "gray", fontSize: "35px", cursor: "pointer", marginRight: "5px" }}
      ...
      <div className="fade-in ml-24 my-20" id="fees">
        <h1 className="font-bold text-black text-center">Send Us a Direct Email</h1>

        <form className="flex flex-col space-y-4" action={handleSubmit}>
          {formState?.message && (
            <div
              className={`p-3 rounded-md ${formState.success ? "bg-green-100 text-green-700" : "bg-red-100 text-red-700"}`}
            >
              {formState.message}
            </div>
          )}
          <div>
            <input
              className="rounded-md border border-gray-300 px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
              type="email"
              name="email"
              required
          ...
          <div>
            <input
              ...
              placeholder="Contact"
            />
            {formState?.errors?.contact && <p className="text-red-500 text-sm mt-1">{formState.errors.contact[0]}</p>}
          </div>
          <div>
            <textarea
              className="rounded-md border border-gray-300 px-4 py-2 h-24 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full"
              name="message"
              required
              placeholder="Message"
            />
          ...
          <button
            ...
            className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-70"
          >
        ...
        <div className="my-5 flex items-center justify-center">
          ...
          <span className="text-gray-600">
            <a href="tel:+256 702 940003">
              <Phone className="h-8 w-8 text-dark mr-2" />
            </a>
          </span>
        </div>
      </div>
